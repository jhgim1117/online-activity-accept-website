...
def choice_place():
    first_floor = {1:"체력단련장", 2:"정보체육 연구실", 3:"정보R&E실", 4:"입학 사정관실", 5:"진로진학상담실",\
